...
module.exports = [
  ...
  {
    files: ['.eslint.config.js', 'bin/variety', 'build.js', 'cli/**/*.js', 'test/**/*.js'],
    ignores: ['test/fixtures/**/*.js'],
    rules: nodeModernizationRules,
  },
  {
    files: ['variety.js', 'core/analyzer.js', 'shell/mongo-shell-adapter.js'],
    ...
    // shell/mongo-shell-adapter.js source files above; we lint both the sources
