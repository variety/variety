...
module.exports = (async () => {
  ...
  return [
    ...
    // Extract Markdown fenced code blocks into virtual files so the JavaScript
    // rules above cover documented examples while markdownlint checks prose.
    ...markdown.configs.processor,
    {
      files: ['**/*.md/**'],
      rules: {
        // Mongo shell examples intentionally redeclare globals such as collection.
        'no-redeclare': 'off',
      },
    },
  ];
